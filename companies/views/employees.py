...
class Employees(Base):
    ...
    def get(self, request):
        ...
        # Filtra todos os funcionários da empresa, excluindo o dono.
    ...
    def post(self, request):
        ...
        # Cria o funcionário usando a função de signup.
...
class EmployeeDetail(Base):
    ...
    def delete(self, request, employee_id):
        ...
        employee.delete()  # Remove o usuario da tabela employee
